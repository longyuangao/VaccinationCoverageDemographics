...
```{r}
#READ DATA
flu<-read.csv("resources/flu_vax_coverage.csv")
education <- read.csv("resources/education.csv")
pop<- read.csv("resources/population.csv")
income<- read.csv("resources/income.csv")
