...
```{r}
#READ DATA
flu<-read.csv("C:\\Users\\longy\\Downloads\\flu.csv")
education <- read.csv("C:\\Users\\longy\\Downloads\\t.csv")
pop<- read.csv("C:\\Users\\longy\\Downloads\\pop.csv")
income<- read.csv("C:\\Users\\longy\\Downloads\\income.csv")
...
NOTE: THIS DATA IS FROM 2021 CENCUS, SO IT IS BETTER TO BE COMBINED WITH 2021 FLU VACCINE DATA
...
#Try plotting to see if I transformed the data correctly
us_by_year%>%
ggplot()+
  geom_line(aes(ym, Estimate....))
```
