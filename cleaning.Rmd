...
nonWantedLevels<-c("Guam", "IL-City of Chicago", "IL-Rest of state", "NY-City of New York", "NY-Rest of state", "PA-Philadelphia", "PA-Rest of state", "TX-Bexar County", "TX-City of Houston", "TX-Rest of state", "Puerto Rico", "U.S. Virgin Islands")

test <-
  flu %>%
    filter(Vaccine=="Seasonal Influenza") %>%
    filter(Geography.Type == "States/Local Areas") %>%
    filter(!Geography %in% nonWantedLevels)
