...
First, let's see if there are geographical patterns associated with flu vaccination coverage in 2021. In this section we use the choroplethr package and the clean demo_df data we created, which contains demographical data and flu vaccination coverage rate data in 2021.
