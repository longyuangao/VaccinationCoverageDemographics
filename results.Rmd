...
race<-ggplot(data=flu_race)+
  geom_bar(aes(x=	flu_race$Dimension, y=flu_race$Estimate....),stat="identity", fill="skyblue1")+
...
age<-ggplot(data=flu_age)+
  geom_bar(aes(x=	flu_age$Dimension, y=flu_age$Estimate....),stat="identity", fill="skyblue1")+
...
flu_race_ts$Dimension[flu_race_ts$Dimension == "≥6 months Other or Multiple Races, Non-Hispanic"] <- "Other or Multiple Races, Non-Hispanic"

ggplot(data=flu_race_ts)+
  geom_line(aes(x=ym,y=flu_race_ts$Estimate....))+
  facet_wrap(.~Dimension)+
  labs(x="Year", y="Flu Vaccination Coverage Rate",title = "Flu Vaccination Coverage Rate by Race, 2009-2021")
...
ggplot(data=flu_age_ts)+
  ...
  facet_wrap(.~Dimension)+
  labs(x="Year", y="Flu Vaccination Coverage Rate",title = "Flu Vaccination Coverage Rate by Age Group, 2009-2021")
...
plot_grid(g,f,h, nrow=3,align = "v")
```
